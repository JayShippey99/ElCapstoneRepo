...
{
    // i wonder if board light should be replaced with dot condition
    ...
    public enum Triggers // so idk what to do about this, its cool, but idk how often we'll need it
    {
        AllLetters,
        DescendingValue,
        EveryOtherInput,
